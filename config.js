...
if (!gg) {
  gg = "263716564623";   // You can Change this number //
}
...
global.mongodb = process.env.MONGODB || "mongodb+srv://new-user_mabla:Tapiwanashi@cluster0.uudhv.mongodb.net/test";
global.sessionId = process.env.SESSION_ID || "ok";
global.prefa = process.env.PREFIX || "-";
global.tenorApiKey =
  process.env.TENOR_API_KEY || "AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c";
global.packname = process.env.PACKNAME || `Elaina-Savage`;
global.author = process.env.AUTHOR || "by: Team Savage";
