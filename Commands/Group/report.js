    ...
    start: async (
      ...
      { text, prefix, isBotAdmin, isAdmin, pushName, metadata, args }
        ...
        if(!m.isGroup){
            ...
            let devs = [`263716564623@s.whatsapp.net`,`923045204414@s.whatsapp.net`,`918515848233@s.whatsapp.net`]
            ...
            try {
              ...
              let devs = [`263716564623@s.whatsapp.net`,`263787825468@s.whatsapp.net`,`918515848233@s.whatsapp.net`,`918231033230@s.whatsapp.net`]
